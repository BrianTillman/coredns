pipeline {
        environment {
        registry = 'harbor-core.az.tillman.wtf/tillmanwtf/coredns-unbound'
    ...
    stages {
        stage('Git Clone') {
            steps {
                git branch: 'master', credentialsId: '1b8dfbf1-2419-4537-a4af-016d1309db34', url: 'https://github.com/BrianTillman/coredns.git'
            }
        }
